...
* **Most clients say NO; only about 11% say YES **
...
## Methodology: Data Preparation (s)
...
## LogReg: Feature Selection & Linearity  
...
$y \sim job + marital + education + balance + housing + loan +$
...
```{r, echo=FALSE, results='asis', fig.width=5, fig.height=3.5}

plot(cv.ridge) 
plot(cv.lasso)
```

## LogReg: Evaluation & Coefficients
